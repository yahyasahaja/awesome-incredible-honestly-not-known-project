class CourseClass {
  postgraduate = [
    {
      ...
      start: "11 Oct, 2019",
      duration: "9 Months",
      description: "Begin your journey with the Post Graduate Program in Full Stack Web Development, in collaboration with Caltech CTME, and get an understanding of what lies ahead in your journey and how to get the maximum benefit out of this course. Kick-start your journey with the preparatory courses and the 'Getting Started' bundle.",
      learningpath: [
        {
          order: 1,
          title: "PG FSD - Phase-1: Implement OOPS using JAVA with Data Structures and Beyond",
          description: "Revisit the basics of Software Development with this introductory phase of our Full Stack Web Development Post Graduate Program. Learn Agile and Scrum methodologies to deliver projects on time, and understand the building blocks of Java data structures and their application in object-oriented programming. Develop a comprehensive understanding of Git to manage version control systems, and Maven to manage project dependencies.",
        },
        {
          order: 2,
          title: "PG FSD - Phase-2: Become a back-end expert",
          description: "Learn all aspects of back-end technologies by acquiring in-depth skills of SQL, Java servlets, and the relational database ORM with Hibernate. Learn to connect databases with JDBC and gain an understanding of RESTful web services.",
        },
        {
          order: 3,
          title: "PG FSD - Phase-3: Implement Frameworks the DevOps way",
          description: "Develop advanced UI skills with HTML and CSS, and build 3-tier applications with practical front-end features using the Spring framework, Angular, JUnit5, and SoapUI. You will also learn how to deploy continuous integration and automation using Jenkins.",
        },
        {
          order: 4,
          title: "PG FSD - Phase-4: Develop a Web Application using frontend stack",
          description: "Create industry-standard applications and websites using the front-end stack technologies such as HTML, CSS, JavaScript, and Angular. Employ a range of data types to handle your applications efficiently using MongoDB.",
        },
        {
          order: 5,
          title: "PG FSD - Phase-5: Testing in a DevOps Lifecycle",
          description: "Gain a comprehensive understanding of automation testing and integration with Selenium WebDriver. Learn how to create seamless development and production environments using containerization with a widely used tool—Docker, and manage your applications on the Amazon S3 server.",
        },
        {
          order: 6,
    ...
    },
    {
      ...
      start: "20 Sep, 2020",
      duration: "12 Months",
      description: "Get started with the Post Graduate Program in Cloud Computing in collaboration with Caltech CTME and explore everything about the program. Kickstart your Cloud journey with our preparatory courses: Introduction to Cloud Computing, AWS Technical Essentials, Microsoft Azure Fundamentals",
      learningpath: [
        {
          order: 1,
          title: "PG CC - Microsoft Certified Azure Administrator: AZ:104",
          description: "Simplilearn’s Azure Administrator training provides you with a deep understanding of the entire administrative lifecycle in Azure environment. This Azure course shows you how to maintain services related to computing, storage, network, and security. Enhance your Azure Administrator skills and prepare to ace the AZ-104 Azure Administrator exam.",
        },
        {
          order: 2,
          title: "PG CC - Microsoft Certified Azure Developer Associate: AZ:204",
          description: "This Azure Developer Certification training aligns with the latest (2020) edition of Azure Developer Certified Associate exam AZ-204. AZ-204 is the updated version of the existing exam for the Microsoft Azure Developer Associate: AZ-203. This exam verifies your ability to select, develop, and implement Azure Cloud technology solutions.",
        },
        {
          order: 3,
          title: "PG CC - Microsoft Azure Architect Technologies: AZ:303",
          description: "The Microsoft Azure Architect Technologies AZ-303 online training course prepares you for a career as a certified Azure Cloud Solutions Architect. You will learn how to manage Azure resources, configure and deploy virtual machines, and master Azure Cognitive Services solutions as you become familiar with the Azure platform.",
        },
        {
          order: 4,
          title: "PG CC - Microsoft Azure Architect Design: AZ:304",
          description: "This Azure training course covers the more advanced activities on the Azure platform, such as managing Azure resources, configuring and deploying virtual machines and networks, mastering Azure AD, and securing data. You will also learn how to identify data storage options, integrate SaaS service on Azure, author deployments, and more.",
        },
        {
          order: 5,
          title: "PG CC - AWS Solutions Architect SAA C02",
          description: "This AWS Solutions Architect Certification training will enable you to design, plan, and scale AWS implementations utilizing over 70 Cloud Computing services. The course is aligned with the latest AWS exam featuring Amazon designated best practices.",
        },
        {
          order: 6,
          title: "PG CC - AWS Developer Associate",
          description: "Simplilearn’s AWS Developer Associate training builds upon the skills learned from the AWS Technical Essentials course. This course will teach you how to write code and design scalable applications, implement application security and testing, and develop expertise with key AWS components such as S3, DynamoDB, Elastic Beanstalk, and CloudFormation.",
        },
        {
          order: 7,
          title: "PG CC - AWS Sysops Associate",
          description: "This AWS SysOps training is a prerequisite to the DevOps Engineer Certification. You will learn how to migrate on-premise applications to AWS, control the flow of data to and from AWS, master the AWS management console, implement operational cost controls, and enhances your ability to leverage AWS resources and services efficiently.",
        },
        {
          order: 8,
          title: "PG CC - Cloud Computing Capstone Project",
          description: "This Cloud Computing Capstone project will give you an opportunity to implement the skills you learned throughout this program. Through dedicated mentoring sessions, you’ll learn how to solve a real-world, industry-aligned Cloud problem. The project is the final step in the learning path and will enable you to showcase your expertise in Cloud Computing to future employers.",
        },
      ],
    },
    {
      ...
      start: "20 Sep, 2020",
      duration: "9 Months",
      description: "Get started with the Post Graduate Program in DevOps in collaboration with Caltech CTME and explore everything about the program. Kickstart your DevOps journey with our preparatory courses: Linux Training, Programming Refresher, Agile Scrum Foundation, Agile Scrum Master.",
      learningpath: [
        {
          order: 1,
          title: "PG DO - DevOps Certification Training",
          description: "Simplilearn’s DevOps Certification Training Course will enable you to prepare you for a career in DevOps, a fast-growing field that bridges the gap between software developers and operations professionals. Learn the DevOps tools and methodologies, and excel for your next role as a DevOps practitioner.",
        },
        {
          order: 2,
          title: "PG DO - Git and GitHub Training",
          description: "Learn the basics of Git—a version control system (VCS), and understand how to set up Git in your system, list the three-stage workflow in Git, create branches and track files, create a repository in Git, GitHub and more.",
        },
        {
          order: 3,
          title: "PG DO - CI/CD Pipeline with Jenkins",
          description: "This CI/CD Pipelines with Jenkins Certification Training course will help you learn server automation, continuous integration, build pipelines and configuration tools, automated testing and code quality improvement, and distributed system in Jenkins through intensive, hands-on practice assignments.",
        },
        {
          order: 4,
          title: "PG DO - Configuration Management with Chef, Puppet and Ansible",
          description: "Configuration management is one of the most important stages in the DevOps pipeline. This course provides an in-depth understanding of the concepts of Chef, Puppet, and Ansible. The DevOps lifecycle is a collection of engineering practices providing a systematic way to manage all of the entities required for efficient deployment.",
        },
        {
          order: 5,
          title: "PG DO - Docker Certified Associate Certification Training",
          description: "This hands-on Docker certification training course is aligned with the Docker Certified Associate (DCA) examination. You will learn core Docker technologies such as Docker Hub, Docker Compose, Docker Swarm, Dockerfile, Docker Containers, Docker Engine, Docker Images, Docker Network, Docker Daemon, and Docker Storage.",
        },
        {
          order: 6,
        ...
        },
        {
          ...
          description: "Simplilearn’s DevOps on AWS course is structured to build your understanding of both technologies using the advanced skills on CodeBuild, CodeDeploy, and CodePipeline to automate continuous delivery and continuous integration for your application.",
        },
        {
          order: 8,
          title: "PG DO - DevOps Capstone Project",
          description: "This DevOps capstone project will give you an opportunity to implement the skills you learned throughout this program. Through dedicated mentoring sessions, you’ll learn how to solve a real-world, industry-aligned problem. This project is the final step in the learning path and will enable you to showcase your expertise in DevOps to future employers.",
        },
      ],
    },
    {
      ...
      start: "07 Nov, 2020",
      duration: "8 Months",
      description: "Get started with the Post Graduate Program in Data Engineering in partnership with Purdue University and explore everything about the program. Kick-start your journey with the preparatory courses on data engineering with Scala and Hadoop, and big data for data engineering.",
      learningpath: [
        {
          order: 1,
          title: "PG DE - Big Data Hadoop and Spark Developer",
          description: "Gain insights into how to improve business productivity by processing large volumes of data and extracting valuable information from them.",
        },
        {
          order: 2,
          title: "PG DE - AWS Tech Essentials",
          description: "Learn how to navigate the AWS management console, understand AWS security measures, storage, and database options, and gain expertise in web services like RDS and EBS.",
        },
        {
          order: 3,
          title: "PG DE - Big Data on AWS",
          description: "Become familiar with the Amazon Web Services (AWS) cloud platform, including Kinesis Analytics, and AWS big data storage, processing, analysis, visualization, and security services.",
        },
        {
          order: 4,
          title: "PG DE - Azure Fundamentals",
          description: "Learn to create the most common Azure services, including virtual machines, web apps, SQL databases. Learn about the features of Azure Active Directory and the methods of integrating the cloud service with on-premises Active Directory.",
        },
        {
          order: 5,
          title: "PG DE - Azure Data Engineer",
          description: "Implement data solutions, manage and develop data processing; and monitor and optimize data solutions using the following Azure services: Azure Cosmos DB, Azure SQL Database, Azure Synapse Analytics, Azure Data Lake Storage, Azure Data Factory, Azure Stream Analytics, Azure Databricks, and Azure Blob storage.",
        },
        {
          order: 6,
          title: "PG DE - Data Engineer Capstone",
          description: "Showcase your new data engineering skills with a hands-on, industry-relevant Capstone project which brings everything you learned in the program together into one portfolio-worthy example. You can choose to work on projects in ecommerce, BFSI, or video sharing to make your practice more relevant.",
        },
      ],
    },
    {
      ...
      start: "26 Sep, 2020",
      duration: "12 Months",
      description: "Get started with the Post Graduate Program in AI and Machine Learning in partnership with Purdue University and explore everything about the program. Kickstart your AI journey with the preparatory courses on Statistics and Programming.",
      learningpath: [
        {
          order: 1,
          title: "PG AI - Python for Data Science",
          description: "Kickstart your learning by getting an understanding of Python language and libraries, writing the scripts using the Jupyter-based lab environment.",
        },
        {
          order: 2,
          title: "PG AI - Data Science with Python",
          description: "Elevate your Python skills to a new level with this interactive, hands-on course and establish your mastery of Data Science and analytics techniques using Python programming.",
        },
        {
          order: 3,
          title: "PG AI - Machine Learning",
          description: "Master Machine Learning techniques, including supervised and unsupervised learning and hands-on modeling rounding out your Data Science education.",
        },
        {
          order: 4,
          title: "PG AI - Deep Learning with Tensorflow and Keras",
          description: "Master the concepts of Deep Learning to build artificial neural networks and traverse layers of data abstraction and get a solid understanding of Deep Learning using TensorFlow and Keras.",
        },
        {
          order: 5,
          title: "PG AI - Advanced Deep Learning and Computer Vision",
          description: "Advance your skills with real applications of computer vision, Generative- Adversarial Networks (GANs), distributed parallel computing with GPUs and deployment of deep learning models on cloud.",
        },
        {
          order: 6,
          title: "PG AI - Natural Language Processing and Speech Recognition",
          description: "Understand the concepts of NLP, feature engineering, natural language generation, automated speech recognition, speech to text conversion, text to speech conversion, and voice-assistance devices (including building Alexa skills).",
        },
        {
          order: 7,
          title: "PG AI - Reinforcement Learning",
          description: "You will learn how to solve reinforcement learning problems with a variety of strategies, using Python and TensorFlow and and use different algorithms to solve problems.",
        },
        {
          order: 8,
          title: "PG AI - AI and Machine Learning Capstone Project",
          description: "Culminate your new AI-ML skills with a hands-on, industry-relevant capstone project bringing together every course into one portfolio-worthy capstone.",
        },
      ],
    },
    {
      ...
      start: "03 Oct, 2020",
      duration: "12 Months",
      description: "Get started with the Post Graduate Program in Data Science in partnership with Purdue University and explore everything about the program. Kickstart your Data Science journey with the preparatory courses on Statistics and Programming.",
      learningpath: [
        {
          order: 1,
          title: "PG DS - R Programming for Data Science",
          description: "Discover R Programming with this introductory course. Learn how to write R code, utilize R data structures, and create your own functions.",
        },
        {
          order: 2,
          title: "PG DS - Data Science with R",
          description: "The most in-demand open-source technology is R Programming. Learn how this programming language unlocks the power of Data Science with hands-on experience and real-world applications.",
        },
        {
          order: 3,
          title: "PG DS - Python for Data Science",
          description: "Kickstart your learning of Python for Data Science with this introductory course and familiarize yourself with programming, tastefully crafted by IBM.",
        },
        {
          order: 4,
        ...
        },
        {
          ...
          description: "Understand the fundamentals of Natural Language Processing using the most popular library; Python’s Natural Language Toolkit (NLTK).",
        },
        {
          order: 7,
          title: "PG DS - Tableau Training",
          description: "This course in Tableau Desktop 10 training will help you gain a variety of skills in the powerful platform including building visualizations, organizing data, and designing dashboards.",
        },
        {
          order: 8,
          title: "PG DS - Data Science Capstone",
          description: "Culminate your new Data Science skills with a hands-on, industry-relevant capstone project bringing together every course into one portfolio-worthy capstone.",
        },
      ],
    },
  ];
  ...
  master = [
    ...
    },
    {
      ...
      duration: "15 Months",
      detail: [
        "12 tools & Rigorous curriculum",
        "Master's certificate"
      ],
      description: "Do you want to have an edge over others in the extremely demanding field of software engineering? You’ve come to the right place! Simplilearn’s Software Engineering Masters program will train you to gain expertise on different levels of Software Engineering, Programming, Frontend, Backend, DevOps tools, Cloud, and then Agile.",
      learningpath: [
        {
          order: 1,
          title: "C Programming",
          description: "Are you looking to learn programming but not sure how and where to start? Simplilearn’s C Programming Language online course provides beginners with easy-to-follow instructions and an arsenal of resources to make them fluent in C language methodologies such as variables, data types, loops, arrays, etc.",
        },
        {
          order: 2,
        ...
        },
        {
          ...
          description: "More businesses are using MongoDB development services, the most popular NoSQL database, to handle their increasing data storage and handling demands. The MongoDB certification course equips you with the skills required to become a MongoDB Developer.",
        },
        {
          order: 4,
          title: "Node.js Training",
          description: "Are you a developer looking to build scalable web applications at lightning speed? Simplilearn’s Node JS training enables you to build network applications quickly and efficiently using JavaScript. The course helps you gain an in-depth knowledge of concepts such as Express.js, Node Packet Manager (npm), shrink-wrap, NPM Vet, asynchronous programming, REST, Express.js with MongoDB, SQLite CRUD operations, and more.",
        },
        {
          order: 5,
          title: "Angular Training",
          description: "The Angular course enables you to master front-end web development with Angular. It helps you gain in-depth knowledge of concepts such as TypeScript, Bootstrap Grid System, Dependency Injections, SPA (Single Page Application), Directives, Forms, Pipes, Promises, Observables, and understand the testing of the Angular class.",
        },
        {
          order: 6,
          title: "AWS Solutions Architect",
          description: "The AWS certification training is designed to help you gain an in-depth understanding of Amazon Web Services (AWS) architectural principles and services such as IAM, VPC, EC2, EBS and more. The course is aligned with the latest exam announced by AWS, and you will learn how to design and scale AWS Cloud implementations with best practices recommended by Amazon. AWS certified solutions architects command average salaries of $129,000 per year, so get started in this exciting field today.",
        },
        {
          order: 7,
    ...
    },
    {
      ...
      description: "The ITIL® Lifecycle Expert program will enable you to master all 5 phases of the IT service management lifecycle. You’ll learn to align IT strategy with business vision, manage the service delivery process across the lifecycle and develop capabilities to ensure a smooth transition of new services into operations. Boost your salary by 40% over non certified peers with this expert course.",
      learningpath: [
        {
          order: 1,
          title: "ITIL® Intermediate CSI",
          description: "The ITIL® Intermediate Continual Service Improvement (CSI) certification is one of the key qualifications in ITIL Expert training. It also serves as a free-standing qualification to establish your expertise in continual service improvement and enhance your IT service management career opportunities.",
        },
        {
          order: 2,
          title: "ITIL® Intermediate SD",
          description: "This ITIL® Intermediate Service Design (SD) course is one of the key qualifications in the ITIL Service Lifecycle category, designed to expose you to the architectures, processes, policies, and documentation of IT service management. You’ll learn about best practices in the design of IT services.",
        },
        {
          order: 3,
          title: "ITIL® Intermediate SO",
          description: "This ITIL® Intermediate Service Operation (SO) training course is one of the key qualifications within ITIL Service Lifecycle training and proves your ability to enable responsive, stable, and repeatable IT service delivery. The ITIL framework sets internationally recognized benchmarks for IT professionals.",
        },
        {
          order: 4,
          title: "ITIL® Intermediate SS",
          description: "The ITIL® Intermediate Service Strategy (SS) certification establishes your ability to effectively plan, design, develop, and implement IT service management. This course is one of the key qualifications in ITIL Expert training but also serves as a free-standing qualification.",
        },
        {
          order: 5,
          title: "ITIL® Intermediate ST",
          description: "ITIL® Intermediate ST Certification qualifies you for the ITIL Service Lifecycle training that will help you become an expert. This certification will validate your knowledge of process elements, practice components, and management techniques to build, test, and implement products and services.",
        },
        {
          order: 6,
          title: "ITIL® Managing across the Lifecycle (MALC)",
          description: "This ITIL® Managing Across the Lifecycle (MALC) course, the final module within the ITIL Service Lifecycle training, establishes your ability to integrate service management processes across the full range of IT practices. It tests your knowledge of the key content topics of the ITIL publication.",
        },
      ],
    },
    {
      ...
      description: "This program will advance your career as an automation test engineer. You’ll learn top skills demanded in the industry, including GIT, Selenium, Jenkins, and JMeter to apply engineering to software development processes and build quality products.",
      learningpath: [
        {
          order: 1,
          title: "Phase-1: Implement software development and database fundamentals through agile",
          description: "Brush up on your knowledge of software development fundamentals; agile and scrum methodologies; Java and data structures; GIT to manage version control systems; SQL to maintain databases; and software testing to write test cases.",
        },
        {
          order: 2,
          title: "Phase-2: Get started with Functional Testing, TDD, and DevOps integration",
          description: "Familiarize yourself with automation testing technologies through tools like Jenkins, TestNg, Maven, JUnit 5, and Gherkin.",
        },
        {
          order: 3,
          title: "Phase-3: Test and monitor your applications through Non-functional and API Testing",
          description: "This phase will enable you to create a test plan, run test cases, analyze them, perform test execution, and monitor application performance using JMeter and Postman.",
        },
        {
          order: 4,
          title: "Phase-4: Learn mobile automation and cloud testing",
          description: "Automate your mobile automation test cases with Appium and deploy those in the cloud and DevOps environments using AWS and Docker.",
        },
        {
          order: 5,
          title: "Automation Test Engineer Capstone",
          description: "Automation test engineer Capstone project provides you with hands-on working experience — the objective being to develop the entire application from scratch, deploy it into a pseudo-production environment, and successfully test it.",
        },
      ],
    },
  ];

  findPostGraduateById(_id) {
